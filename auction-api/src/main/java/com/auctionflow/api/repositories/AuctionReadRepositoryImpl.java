...
public interface AuctionReadRepositoryImpl extends JpaRepository<com.auctionflow.api.entities.Auction, String>, AuctionReadRepository {
    ...
    @Query("SELECT new com.auctionflow.api.dtos.AuctionDetailsDTO(a.id, i.id, i.sellerId, i.title, i.description, a.status, a.startTs, a.endTs, a.reservePrice, a.buyNowPrice, a.hiddenReserve, b.amount, b.bidderId, b.serverTs) " +
           "FROM Auction a " +
