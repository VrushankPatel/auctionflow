...
public class WinnerDeclaredEvent extends DomainEvent {
    private final WinnerId winnerId;

    public WinnerDeclaredEvent(AuctionId auctionId, WinnerId winnerId, UUID eventId, Instant timestamp, long sequenceNumber) {
